...
def train_semantic_segmentation(model, train_loader, valid_loader, criterion, optimizer, scheduler, early_stopping, mlflow_client, start_epoch, end_epoch, device):
    # TODO we could define weights to weight classes with few data points
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        for i, (points, labels) in enumerate(train_loader, 1):
            model = model.train()
